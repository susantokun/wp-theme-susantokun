var syntaxHighlight = (function () {
	...
	return (function (t) {
			...
			(a.value = x(a.value)),
				...
				(e.className = (function (e, n, t) {
					var r = n ? s[n] : t,
						a = [e.trim()];
					return (
						e.match(/\bsyntaxHighlight\b/) || a.push("syntaxHighlight"),
		...
		Object.assign(t, {
			...
			initSyntaxHighlight: N,
			initSyntaxHighlightOnLoad: function () {
...
syntaxHighlight.registerLanguage(
	"plaintext",
	(function () {
		"use strict";
		return function (t) {
